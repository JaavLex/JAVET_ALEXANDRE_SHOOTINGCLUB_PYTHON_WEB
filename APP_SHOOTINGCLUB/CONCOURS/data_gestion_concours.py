...
class GestionFilms():
    ...
    def films_afficher_data(self):
        try:
            ...
            strsql_films_afficher = """SELECT id_concours, date_concours, type_concours, nom_stand_de_tir, adresse_stand_de_tir FROM T_Concours AS T1 
    ...
    def add_film(self, valeurs_insertion_dictionnaire):
        try:
            ...
            # Rssure la personne qui dévelloppe que les valeurs à insérer sont bien à disposition.FILMS
